...
#' Avalia dia mais rentavel do período para operação de compra/venda. Analise aritmetica do valor.
...
#' @return Desempenho diario do cripto ativo
#' @examples
#' moreProfitableDay("BTC-USD","2018-01-01","2019-01-01")
#' @import quantmod


moreProfitableDay <- function( asset = NA,
                               startDate = NA,
                               endDate = NA) {
